...
Together, these modules create a simple end-to-end autonomous driving pipeline in simulation:
the car detects the lane, computes how to steer, and reacts to objects in its path.
